...
import { approveOnboardingByManager } from "../../modules/onboarding/onboarding.actions.js";
import {
...
export async function runOnboardingApproveManagerCommand(context: CliContext) {
  ...
  try {
    const action = await approveOnboardingByManager({
      workflowInstanceId,
