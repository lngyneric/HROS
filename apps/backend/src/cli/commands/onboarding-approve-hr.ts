...
import { approveOnboardingByHr } from "../../modules/onboarding/onboarding.actions.js";
import {
...
export async function runOnboardingApproveHrCommand(context: CliContext) {
  ...
  try {
    const action = await approveOnboardingByHr({
      workflowInstanceId,
